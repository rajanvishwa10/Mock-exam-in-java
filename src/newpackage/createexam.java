...
public class createexam extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/exam", "root", "tiger");
            Statement st= con.createStatement();
            String Query="insert into quest(question,op1,op2,op3,op4,ans,qn,marks,qset) values(?,?,?,?,?,?,?,?,?)";
